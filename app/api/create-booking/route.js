...
export async function POST(request) {
  ...
  try {
    ...
    //     (user.id, check_in_date, check_out_date, total_price, discount, status, payment_status, expires_at, created_at)
    ...
    const orderAmount = (total_price - total_price * discount);
    // console.log(orderAmount);return
